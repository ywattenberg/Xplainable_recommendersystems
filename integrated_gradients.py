...
def main():
    ...
    white_base_img = image_transform(np.ones([1,3,224,224], dtype=np.float32)).to(device)
    black_base_img = image_transform(np.zeros([1,3,224,224], dtype=np.float32)).to(device)
