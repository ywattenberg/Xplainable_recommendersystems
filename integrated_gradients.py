...
def main():
    ...
    white_base_img = image_transform(Image.fromarray(np.ones([1,3,224,224], dtype=np.float32))).to(device)
    black_base_img = image_transform(Image.fromarray(np.zeros([1,3,224,224], dtype=np.float32))).to(device)
